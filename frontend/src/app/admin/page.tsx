...
const adminData = {
  overview: [
    {
      ...
      value: "1,234",
      description: "including farmers and customers",
      icon: <Users className="h-6 w-6 text-gray-400" />,
    },
    {
      title: "Active Farmers",
      value: "215",
      description: "Currently listed on platform",
      icon: <Sprout className="h-6 w-6 text-gray-400" />,
    },
    {
      title: "New Registrations (7 Days)",
      value: "48",
      description: "Farmers & Customers",
      icon: <User className="h-6 w-6 text-gray-400" />,
    },
    {
      title: "System Uptime",
      value: "99.9%",
      description: "Stable across all services",
      icon: <Clock className="h-6 w-6 text-gray-400" />,
    },
  ],
  pendingApprovals: [
    {
      applicant: "John Doe Organics",
      applicationDate: "2024-07-20",
      status: "Pending",
    },
    {
      applicant: "Green Valley Farms",
      applicationDate: "2024-07-18",
      status: "Pending",
    },
    {
      applicant: "Harvest Haven",
  ...
  recentActivity: [
    ...
    {
      text: "Product listing updated: Fresh Organic Carrots by Green Acres Farm",
      time: "5 hours ago",
    },
    {
      text: "Customer support ticket closed: #2024-07-22-001",
      time: "(Yesterday)",
    },
    {
      text: "System backup completed: Full database backup successful",
      time: "(2 days ago)",
    },
  ],
};
...
export default function App() {
  ...
  const [adminData, setAdminData] = useState<DashboardOverview | null>(null);
    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          "http://localhost:4000/admin/dashboard-overview"
        );
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8">
          ...
          <Card className="rounded-xl p-6 bg-white dark:bg-gray-800 shadow-lg border dark:border-gray-700 mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Review new farmer profiles awaiting approval to sell on
              FarmFresh.io.
            </p>
          ...
          <Card className="rounded-xl p-6 bg-white dark:bg-gray-800 shadow-lg border dark:border-gray-700 mb-8">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
              Items that require attention due to customer reports or system
              flags.
            </p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
